...
//	create a case study custom post type
    ...
    register_post_type('services_page', 
        array(
            'labels' => array(
                'name' => __( 'Services Page'),
                'singular_name' => __( 'Service Page' )
            ),
            'public' => true,
            'has_archive' => true,
            'rewrite' => array( 'slug' => 'services-page'),
        )
    );
}
...
function accelerate_child_scripts(){
    ...
    wp_enqueue_style( 'accelerate-child-google-fonts',  '//fonts.googleapis.com/css?family=Underdog&display=swap');
}
